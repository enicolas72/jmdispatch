 ...
 *
 * <p>This class is not intended for direct use. Use {@link net.eric_nicolas.jmdispatch.DispatchTable#factory(int)}
 * to create dispatch tables.
 *
 * @param <FUNCTOR> the functor interface type ({@link Functor1}, {@link Functor2}, or {@link FunctorN})
 */
