...
public class TestInstanceMethodsMixed {
    ...
    public void testMixedStaticAndInstance() {
        DispatchTable2 table = new DispatchTable2().autoregister(new MixedHandler("inst"));
    ...
    public void testInstanceVoidReturn() {
        ...
        DispatchTable2 table = new DispatchTable2().autoregister(handler);
    ...
    public void testInstancePrimitiveReturn() {
        DispatchTable2 table = new DispatchTable2().autoregister(new PrimitiveHandler(10));
