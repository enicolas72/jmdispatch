...
public class TestInstanceMethods {
    ...
    public void testInstanceDispatch() {
        ...
        DispatchTable table = DispatchTable.factory(2).autoregister(new MyHandler(out));
    ...
    public void testInstanceReturnValues() {
        DispatchTable table = DispatchTable.factory(2).autoregister(new ReturningHandler("[1]"));
    ...
    public void testTwoInstancesSameHandlerClass() {
        ...
        DispatchTable table1 = DispatchTable.factory(2).autoregister(new ReturningHandler("[1]"));
        DispatchTable table2 = DispatchTable.factory(2).autoregister(new ReturningHandler("[2]"));
