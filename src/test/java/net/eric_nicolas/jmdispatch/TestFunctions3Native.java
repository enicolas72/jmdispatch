...
public class TestFunctions3Native {
    ...
    private static final DispatchTableN f_table = new DispatchTableN(3).autoregister(TestFunctions3Native.class);

    static void f(Object o1, Object o2, Object o3) {
        f_table.dispatch(o1, o2, o3);
    }
